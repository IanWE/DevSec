...
// but swapped if the host and target have different endianness.
    ...
    struct Convert_endian<32, false> {
        ...
        static inline Valtype
        convert_host(Valtype v) { return bswap_32(v); }
    };
    ...
    struct Convert_endian<64, false> {
        ...
        static inline Valtype
        convert_host(Valtype v) { return bswap_64(v); }
    };
...
// pointers to unsigned char.
    ...
    struct Swap {
        ...
        static inline Valtype
        readval(const Valtype *wv) { return Convert<size, big_endian>::convert_host(*wv); }

        static inline void
        writeval(Valtype *wv, Valtype v) { *wv = Convert<size, big_endian>::convert_host(v); }

        static inline Valtype
        readval(const unsigned char *wv) { return readval(reinterpret_cast<const Valtype *>(wv)); }

        static inline void
        writeval(unsigned char *wv, Valtype v) { writeval(reinterpret_cast<Valtype *>(wv), v); }
    };
...
// will have the same type parameters.
    ...
    struct Swap<8, big_endian> {
        ...
        static inline Valtype
        readval(const Valtype *wv) { return *wv; }

        static inline void
        writeval(Valtype *wv, Valtype v) { *wv = v; }
    };
...
// misaligned.
    ...
    struct Swap_unaligned<8, big_endian> {
        ...
        static inline Valtype
        readval(const unsigned char *wv) { return *wv; }

        static inline void
        writeval(unsigned char *wv, Valtype v) { *wv = v; }
    };
...
// 64-bit aligned, but are 32-bit aligned.
    ...
    struct Swap_aligned32 {
        ...
        static inline void
        writeval(unsigned char *wv, Valtype v) { Swap<size, big_endian>::writeval(reinterpret_cast<Valtype *>(wv), v); }
    };
