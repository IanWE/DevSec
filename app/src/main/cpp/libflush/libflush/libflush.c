...
#elif TIME_SOURCE == TIME_SOURCE_THREAD_COUNTER
  result = thread_counter_get_timing(session);//get session->thread_counter.value
...
inline void
libflush_memory_barrier()//make sure previous instructions excuted
{
#if defined(__ARM_ARCH_7A__)
